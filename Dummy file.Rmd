...
```
The table above shows the coorelations between the predictor variable and the remaining variables using the best model gained from the tune() function on the SVM model. 
